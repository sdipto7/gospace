...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({SpaceTripNotFoundException.class, SpaceCraftNotFoundException.class})
    public final ResponseEntity<ErrorResponseDto> handleNotFoundException(Exception ex, WebRequest request) {
